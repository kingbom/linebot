package com.kingbom.linebot.helper;
...
/**
 * Created by bombay on 26/8/2018 AD.
 */
@Slf4j
@LineMessageHandler
public class RichMenuHelper {
    ...
    private static String createRichMenu(LineMessagingClient client, String path) throws IOException {
    ...
    private static void imageUploadRichMenu(LineMessagingClient client, String richMenuId, String path) throws IOException {
